...
public class faceSmallhelper {
	...
	import static com.recogntion.faceengine.FaceNetSmallV2Model.paddingIndex;
	import static com.recogntion.faceengine.FaceNetSmallV2Model.reluIndex;

	@Slf4j
	public class FaceNetSmallV2Helper {
	    static final String BASE = "src/main/rescources/face/";
